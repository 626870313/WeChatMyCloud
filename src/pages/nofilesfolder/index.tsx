...
export default function nofilesfolder() {
  ...
  return (
    <View className='relative'>
      ...
      <View className='fixed bottom-10 text-center ml-4 w-11/12'>
        <Button className='text-white bg-sky-600 flex justify-center rounded-full border-none' onClick={fileUpload}>上传文件</Button>
      </View>
